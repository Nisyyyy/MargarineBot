...
module.exports = class extends Event {
    ...
    async run(guild) {
        ...
        const embed = new MessageEmbed()
            ...
            If you found something not quite right or have a suggestion, please use my report command and let my creator know! I do have a TOS for some of my abilities so please refer to [this link](https://github.com/Nisyyyy) for more information. I look forward to having fun with you!`);
